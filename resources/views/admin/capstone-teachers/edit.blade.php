<x-app-layout>
    <div class="py-12">
        <div class="mx-auto max-w-2xl sm:px-6 lg:px-8">
            {{-- Header --}}
            <div class="mb-6">
                <h1 class="text-3xl font-bold tracking-tight text-slate-900">Edit Capstone Teacher</h1>
                <p class="mt-2 text-sm text-slate-600">Update capstone teacher account details</p>
            </div>

            {{-- Form --}}
            <div class="bg-white overflow-hidden shadow-sm rounded-2xl ring-1 ring-slate-200">
                <div class="p-6">
                    <form action="{{ route('admin.capstone-teachers.update', $user) }}" method="POST" class="space-y-6" x-data="{ loading: false }" @submit="loading = true">
                        @csrf
                        @method('PATCH')
                        ...
                        <div class="rounded-lg bg-blue-50 p-4 ring-1 ring-blue-200">
                            <div class="flex gap-3">
                                ...
                                <div>
                                    ...
                                    <p class="mt-1 text-sm text-blue-700">To reset the password, the capstone teacher can do so from their profile settings.</p>
                                </div>
                            </div>
                        </div>
