<x-app-layout>
    <div class="py-12">
        <div class="mx-auto max-w-2xl sm:px-6 lg:px-8">
            {{-- Header --}}
            <div class="mb-6">
                <h1 class="text-3xl font-bold tracking-tight text-slate-900">Add Technical Adviser</h1>
                <p class="mt-2 text-sm text-slate-600">Create a new technical adviser account</p>
            </div>

            {{-- Form --}}
            <div class="bg-white overflow-hidden shadow-sm rounded-2xl ring-1 ring-slate-200">
                <div class="p-6">
                    <form action="{{ route('admin.technical-advisers.store') }}" method="POST" class="space-y-6" x-data="{ loading: false }" @submit="loading = true">
                        @csrf
                        ...
                        <div class="flex gap-3 pt-4">
                            ...
                            <a
                                href="{{ route('admin.technical-advisers.index') }}"
