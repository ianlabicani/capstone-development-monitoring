            ...
            @if ($teams->count() > 0)
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    @foreach ($teams as $team)
                        <a href="{{ route('technical-adviser.monitoring.show', $team) }}" class="bg-white overflow-hidden shadow-sm rounded-2xl ring-1 ring-slate-200 hover:shadow-md transition block">
