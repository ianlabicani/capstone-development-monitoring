    ...
    <div class="py-12">
        <div class="mx-auto max-w-2xl sm:px-6 lg:px-8">
            ...
            <div class="bg-white overflow-hidden shadow-sm rounded-2xl ring-1 ring-slate-200">
                <div class="p-6">
                    <form action="{{ route('technical-adviser.team-leaders.store') }}" method="POST" class="space-y-6" x-data="{ loading: false }" @submit="loading = true">
                        @csrf
                        ...
                        <div class="flex gap-3 pt-4">
                            ...
                            >
                                ...
                                <span x-text="loading ? 'Creating...' : 'Create Team Leader'"></span>
                            </button>
                            <a
