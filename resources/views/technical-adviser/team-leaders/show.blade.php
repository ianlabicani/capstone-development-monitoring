        ...
        <div class="mx-auto max-w-2xl sm:px-6 lg:px-8">
            ...
            <div class="mb-6 flex items-center justify-between">
                <div>
                    ...
                    <p class="mt-2 text-sm text-slate-600">Team Leader Account</p>
                </div>
                <div class="flex gap-2">
                    <a href="{{ route('technical-adviser.team-leaders.edit', $user) }}" class="inline-flex items-center justify-center rounded-lg bg-orange-600 px-6 py-3 text-sm font-semibold text-white hover:bg-orange-700">
                        <i class="fas fa-edit mr-2"></i> Edit
                    </a>
                    <a href="{{ route('technical-adviser.team-leaders.index') }}" class="inline-flex items-center justify-center rounded-lg border border-slate-300 px-6 py-3 text-sm font-semibold text-slate-900 hover:bg-slate-50">
            ...
            <div class="space-y-4">
                ...
                <div class="bg-blue-50 border border-blue-200 overflow-hidden shadow-sm rounded-2xl ring-1 ring-blue-200">
                    <div class="p-6">
                        ...
                        <p class="text-sm text-blue-700">The team leader can reset their password anytime from their profile settings page.</p>
                    </div>
                </div>
            </div>
        </div>
