    ...
    <div class="py-12">
        <div class="mx-auto max-w-6xl sm:px-6 lg:px-8">
            ...
            <div class="mb-6">
                ...
                <p class="mt-2 text-sm text-slate-600">Overview of {{ $team->name }}'s development activity.</p>
            </div>
                    ...
                    @if ($team->repositories->count() > 0)
                        <div class="divide-y divide-slate-200">
                            @foreach ($team->repositories as $repository)
                                <a href="{{ route('team-leader.repositories.show', $repository) }}" class="flex items-center justify-between p-6 hover:bg-slate-50 transition">
