    ...
    <div class="py-12">
        <div class="mx-auto max-w-6xl sm:px-6 lg:px-8">
            ...
            <div class="mb-6">
                ...
                <p class="mt-2 text-sm text-slate-600">Overview of all capstone teams and their development progress.</p>
            </div>
            ...
            @if ($teams->count() > 0)
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    @foreach ($teams as $team)
                        <a href="{{ route('capstone-teacher.team.show', $team) }}" class="bg-white overflow-hidden shadow-sm rounded-2xl ring-1 ring-slate-200 hover:shadow-md transition block">
