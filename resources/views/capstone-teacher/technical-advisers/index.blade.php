    ...
    <div class="py-12">
        <div class="mx-auto max-w-6xl sm:px-6 lg:px-8">
            ...
            <div class="mb-6 flex items-center justify-between">
                ...
                <a href="{{ route('capstone-teacher.technical-advisers.create') }}" class="inline-flex items-center justify-center rounded-lg bg-orange-600 px-6 py-3 text-sm font-semibold text-white hover:bg-orange-700">
            ...
            <div class="bg-white overflow-hidden shadow-sm rounded-2xl ring-1 ring-slate-200">
                                ...
                                @foreach ($technicalAdvisers as $adviser)
                                    <tr class="hover:bg-slate-50 transition">
                                        ...
                                        <td class="px-6 py-4 text-sm text-right">
                                            ...
                                            >
                                                <a href="{{ route('capstone-teacher.technical-advisers.edit', $adviser) }}" class="text-orange-600 hover:text-orange-700 font-semibold">
                                                ...
                                                <form id="delete-form-{{ $adviser->id }}" action="{{ route('capstone-teacher.technical-advisers.destroy', $adviser) }}" method="POST" class="hidden">
                                                    @csrf
                                                    @method('DELETE')
                                                </form>
                                            </div>
                ...
                @else
                    <div class="p-6 text-center">
                        ...
                        <a href="{{ route('capstone-teacher.technical-advisers.create') }}" class="mt-4 inline-flex items-center justify-center rounded-lg bg-orange-600 px-6 py-3 text-sm font-semibold text-white hover:bg-orange-700">
