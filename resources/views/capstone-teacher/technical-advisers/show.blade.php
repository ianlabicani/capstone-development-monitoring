        ...
        <div class="mx-auto max-w-2xl sm:px-6 lg:px-8">
            ...
            <div class="mb-6 flex items-center justify-between">
                ...
                <div class="flex gap-2">
                    <a href="{{ route('capstone-teacher.technical-advisers.edit', $user) }}" class="inline-flex items-center justify-center rounded-lg bg-orange-600 px-6 py-3 text-sm font-semibold text-white hover:bg-orange-700">
                        <i class="fas fa-edit mr-2"></i> Edit
                    </a>
                    <a href="{{ route('capstone-teacher.technical-advisers.index') }}" class="inline-flex items-center justify-center rounded-lg border border-slate-300 px-6 py-3 text-sm font-semibold text-slate-900 hover:bg-slate-50">
