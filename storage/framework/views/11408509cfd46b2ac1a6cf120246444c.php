...
<?php $component->withAttributes([]); ?>
    <div class="min-h-[calc(100vh-4rem)] flex items-center justify-center px-4 py-12 bg-slate-50">
        <div class="w-full max-w-md bg-white rounded-2xl shadow-sm ring-1 ring-slate-200 p-8">
            <h2 class="text-2xl font-bold text-slate-900 text-center mb-2"><?php echo e(__('Forgot Password')); ?></h2>
            <p class="text-sm text-slate-600 text-center mb-6"><?php echo e(__('Enter your email and we\'ll send you a password reset link.')); ?></p>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="mt-4 text-center text-sm">
                    <a href="<?php echo e(route('login')); ?>" class="text-orange-600 hover:text-orange-700 font-medium"><?php echo e(__('Back to login')); ?></a>
                </div>
            </form>
        </div>
    </div>
...
<?php endif; ?>
<?php /**PATH C:\Users\Ian\Desktop\PROJECTS\SCHOOL\TECH\capstone-development-monitoring\resources\views/auth/forgot-password.blade.php ENDPATH**/ ?>