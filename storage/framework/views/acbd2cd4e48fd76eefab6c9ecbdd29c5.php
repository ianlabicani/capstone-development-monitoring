        ...
        <div class="mx-auto max-w-6xl sm:px-6 lg:px-8">
            ...
            <div class="mb-6 flex items-center justify-between">
                <div>
                    ...
                    <p class="mt-2 text-sm text-slate-600">Led by <?php echo e($team->owner->name); ?> &middot; <?php echo e($team->description ?? 'No description'); ?></p>
                </div>
                <a href="<?php echo e(route('technical-adviser.monitoring.index')); ?>" class="inline-flex items-center justify-center rounded-lg border border-slate-300 px-6 py-3 text-sm font-semibold text-slate-900 hover:bg-slate-50">
            ...
            <div class="mb-6 grid grid-cols-2 md:grid-cols-4 gap-4">
                ...
                <div class="bg-white rounded-2xl ring-1 ring-slate-200 p-6 text-center">
                    <p class="text-3xl font-bold text-orange-600"><?php echo e($weeklyCommits); ?></p>
...
<?php endif; ?>
<?php /**PATH C:\Users\Ian\Desktop\PROJECTS\SCHOOL\TECH\capstone-development-monitoring\resources\views/technical-adviser/monitoring/show.blade.php ENDPATH**/ ?>