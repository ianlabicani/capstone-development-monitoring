    ...
    <div class="py-12">
        <div class="mx-auto max-w-6xl sm:px-6 lg:px-8">
            ...
            <div class="mb-6">
                ...
                <p class="mt-2 text-sm text-slate-600">Overview of <?php echo e($team->name); ?>'s development activity.</p>
            </div>
                    ...
                    <?php if($team->repositories->count() > 0): ?>
                        <div class="divide-y divide-slate-200">
                            <?php $__currentLoopData = $team->repositories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $repository): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <a href="<?php echo e(route('team-leader.repositories.show', $repository)); ?>" class="flex items-center justify-between p-6 hover:bg-slate-50 transition">
                ...
                <div class="bg-white overflow-hidden shadow-sm rounded-2xl ring-1 ring-slate-200">
                    ...
                    <?php else: ?>
                        <div class="p-6 text-center">
                            ...
                            <p class="mt-1 text-sm text-slate-500">Sync your repositories to see commit activity here.</p>
                        </div>
                    <?php endif; ?>
                </div>
            </div>
...
<?php endif; ?>
<?php /**PATH C:\Users\Ian\Desktop\PROJECTS\SCHOOL\TECH\capstone-development-monitoring\resources\views/team-leader/dashboard.blade.php ENDPATH**/ ?>